...
from .views import  eliminar_reserva, colaborador, iniciarsesionColaborador, registro_colaborador, eliminar_colaborador_aprobado, verificar_correo, verificar_usuario, inicio_colaborador, registrar_disponibilidad, perfil_colaborador, horas_disponibles
