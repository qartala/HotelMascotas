...
urlpatterns = [
    ...
    path('crear-membresia/', views.crear_membresia, name='crear_membresia'),
    path('gestionar-membresias/', views.gestionar_membresias, name='gestionar_membresias'),
    path('editar-membresia/<int:membresia_id>/', views.editar_membresia, name='editar_membresia'),
    path('eliminar-membresia/<int:membresia_id>/', views.eliminar_membresia, name='eliminar_membresia')
